...
<body>
    ...
    <form action="c" method="post">
        ...
        <table border="0">
            ...
            <c:forEach var="i" begin="1" end="${sessionScope.itemNum_BookSearch}" step="1">
                <tr>
                    ...
                    <td>
                        ...
                        <c:if test="${sessionScope.whereList_BookSearch.get(i - 1) == 'author'}">
                            <select name="where${i}">
                                <option value="author">Author</option>
                                <option value="title">Title</option>
                                <option value="editor">Editor</option>
                        ...
                        <c:if test="${sessionScope.whereList_BookSearch.get(i - 1) == 'editor'}">
                            <select name="where${i}">
                                <option value="editor">Editor</option>
                                <option value="title">Title</option>
                                <option value="author">Author</option>
            ...
            <tr>
                <td colspan="2" align="right">From year</td>
                <td><input type="text" name="from" value="${sessionScope.from_BookSearch}"></td>
            </tr>
            <tr>
                <td colspan="2" align="right">To year</td>
